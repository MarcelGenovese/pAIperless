...
export default function Sidebar({ activeTab, onTabChange, onSystemCheckOpen }: SidebarProps) {
  return (
    <div className="w-64 bg-white dark:bg-[hsl(0,0%,10%)] border-r border-gray-200 dark:border-[hsl(0,0%,20%)] flex flex-col h-full overflow-hidden">
      {/* Main Navigation */}
      <nav className="flex-1 overflow-y-auto overflow-x-hidden">
          ...
          {mainNavItems.map((item) => (
            <button
              ...
              className={cn(
                ...
                activeTab === item.id
                  ? "bg-blue-50 dark:bg-[hsl(0,0%,18%)] text-blue-700 dark:text-blue-400"
                  : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[hsl(0,0%,15%)]"
              )}
            >
        ...
        {/* Settings Section */}
        <div className="p-4 space-y-1 border-t border-gray-200 dark:border-[hsl(0,0%,20%)]">
          <h3 className="px-3 mb-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
            Einstellungen
          </h3>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-[hsl(0,0%,20%)]">
          <Link
            href="/about"
            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[hsl(0,0%,15%)]"
          >
        ...
        {/* System Controls */}
        <div className="p-4 border-t border-gray-200 dark:border-[hsl(0,0%,20%)] space-y-2">
          <h3 className="px-3 mb-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
            System
          </h3>
