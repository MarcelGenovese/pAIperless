...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-gray-200 dark:border-[hsl(0,0%,20%)] bg-white dark:bg-[hsl(0,0%,10%)] shadow-[0_-10px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
